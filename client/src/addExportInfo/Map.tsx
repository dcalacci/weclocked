...
const Map = (props: { stops: Stops, locs: Locs, clusters: Cluster[], selectedCluster: number | undefined }) => {
  let mapDiv: any;
  let map: any;
  ...
  createEffect(() => {
    ...
    if (c && map) {
      map.flyTo(L.latLng(c.centroid.lat, c.centroid.lng), 15)
    }
  })
